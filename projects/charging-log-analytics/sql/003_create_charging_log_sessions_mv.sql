-- Precompute session-level rows for nightly ranking.
-- This variant creates public.charging_log_sessions_mv as a materialized view.
...
create materialized view public.charging_log_sessions_mv as
with source_rows as (
    select
        src.raw_id,
        src.device_name,
...
as $$
begin
    refresh materialized view public.charging_log_sessions_mv;
end;
$$;
